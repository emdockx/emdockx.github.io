...
list(
  #icon = "speedometer",
  color = "success",
  value = paste0(floor(pace <- sum(df_running_365$distance * df_running_365$pace) / sum(df_running_365$distance)), ":", round((pace %% 1) * 60), "/km")
)
```
...
list(
  #icon = "speedometer",
  color = "success",
  value = paste0(round(sum(df_running_365$speed * df_running_365$hr) / sum(df_running_365$speed), 0), "bpm")
)
```
...
list(
  #icon = "speedometer",
  color = "warning",
  value = paste0(round(sum(df_cycling_365$distance * df_cycling_365$speed) / sum(df_cycling_365$distance), 1), "km/h")
)
```
...
list(
  #icon = "speedometer",
  color = "warning",
  value = paste0(round(sum(df_cycling_365$speed * df_cycling_365$hr) / sum(df_cycling_365$speed), 0), "bpm")
)
```
...
list(
  #icon = "speedometer",
  color = "info",
  value = paste0(floor(pace <- sum(df_swimming_365$distance * df_swimming_365$pace) / sum(df_swimming_365$distance)/10), ":", round((pace %% 1) * 60), "/km")
)
```
...
list(
  #icon = "speedometer",
  color = "info",
  value = paste0(round(sum(df_swimming_365$speed * df_swimming_365$hr) / sum(df_swimming_365$speed), 0), "bpm")
)
```
